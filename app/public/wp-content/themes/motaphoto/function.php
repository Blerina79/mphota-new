...
function theme_enqueue_styles_and_scripts() {
    ...
    wp_enqueue_style('child-theme-style', get_stylesheet_directory_uri() . '/css/lightbox.css', ['parent-style']);
    wp_enqueue_script('theme-contact-modal', get_stylesheet_directory_uri() . '/js/script.js', ['jquery'], null, true);
    wp_enqueue_script('theme-lightbox', get_stylesheet_directory_uri() . '/js/lightbox.js', ['jquery'], null, true);
...
function filter_photos_ajax() {
    ...
    $args = [
        ...
        'tax_query' => [
            ...
            ['taxonomy' => 'format custom', 'field' => 'term_id', 'terms' => $format]
        ],
        'orderby' => $sort ?: 'date',
        'order' => 'ASC'
    ];
...
function register_photo_taxonomies() {
    ...
    register_taxonomy('format custom', 'photo', ['label' => 'Formats de Photos', 'rewrite' => ['slug' => 'format custom'], 'hierarchical' => true]);
}
